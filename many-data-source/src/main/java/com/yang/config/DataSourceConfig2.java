 ...
 */
@Configuration
@MapperScan(basePackages = {"com.yang.test2.dao"}, sqlSessionFactoryRef = "test2SqlSessionFactory")
public class DataSourceConfig2 {
    ...
    public SqlSessionFactory testSqlSessionFactory(@Qualifier("test2DataSource") DataSource dataSource) throws Exception {
        ...
        //Resource[] resources = new PathMatchingResourcePatternResolver().getResources("classpath*:/com/yang/test2/mapper/*.xml");
